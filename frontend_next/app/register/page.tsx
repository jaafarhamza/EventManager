...
import { getErrorMessage, isValidationError, isConflictError } from '@/lib/api/error-handler';
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={errors.firstName ? 'border-(--color-destructive)' : ''}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={errors.lastName ? 'border-(--color-destructive)' : ''}
                  disabled={isSubmitting}
                />
                {errors.lastName && (
                  <p className="text-xs text-(--color-destructive)">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 ${errors.email ? 'border-(--color-destructive)' : ''}`}
                  disabled={isSubmitting}
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`pl-10 pr-10 ${errors.password ? 'border-(--color-destructive)' : ''}`}
                  disabled={isSubmitting}
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`pl-10 pr-10 ${errors.confirmPassword ? 'border-(--color-destructive)' : ''}`}
                  disabled={isSubmitting}
                />
                <button
                  type="button"
